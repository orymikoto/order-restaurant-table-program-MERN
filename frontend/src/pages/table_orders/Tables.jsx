      ...
      <div className='p-2 flex flex-col self-start rounded-2xl m-2 bg-white shadow-[7px_7px_21px_10px_rgba(0,0,0,0.21)]'>
        <div className='flex mx-auto items-center'>
          ...
          <div className='flex flex-col m-2'>
            ...
            <TimePicker placeholder={Start} popupClassName='font-poppins font-medium' className='shadow-md font-poppins font-medium' showNow={false} disabledHours={() => disabledHours('s')} onOk={(time) => setStart(moment(time.toDate()).format('HH:mm').toDate())} hideDisabledOptions={true} defaultValue={dayjs(Start, 'HH:mm')} minuteStep={30} format={'HH:mm'} />
          </div>
          <div className='flex flex-col m-2'>
            <p className='ml-3 text-neutral-600 font-poppins font-semibold text-xs'>End</p>
            <TimePicker placeholder={End} popupClassName='font-poppins font-medium' className='shadow-md font-poppins font-medium' showNow={false} disabledHours={() => disabledHours('e')} onOk={(time) => setEnd(moment(time.toDate()).format('HH:mm').toDate())} hideDisabledOptions={true} defaultValue={dayjs(End, 'HH:mm')} minuteStep={30} format={'HH:mm'} />
          </div>
        ...
        <FloorPlan order_data={Usetable} className='w-[50rem] h-[35rem]'/>
